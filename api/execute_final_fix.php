...
echo "INICIANDO LIMPIEZA GLOBAL DE DUPLICADOS (COMPENSACIÓN ENTRE COMPROBANTES)...\n\n";
...
try {
    ...
    foreach ($accounts as $code) {
        ...
        // Esta consulta busca registros que tengan el mismo monto, fecha y cuenta pero distinto ID/Comprobante
        // Eliminamos el que tenga el ID más alto para quedarnos con el 'original'
        $sql = "DELETE a1 FROM asientos a1
                ...
                INNER JOIN (
                    ...
                    WHERE p2.codigo = :code AND p2.empresa_id = 1
