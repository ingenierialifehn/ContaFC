...
echo "RESTAURANDO COMPROBANTE 10631 Y ASIENTOS (IDs VERIFICADOS)...\n";
...
try {
    ...
    // 2. Restaurar Asientos con IDs reales
    $seats = [
        ['cuenta_id' => 85, 'debito' => 17830.00, 'credito' => 0, 'desc' => 'SALDO SEGÚN LIBROS', 'linea' => 1],
        ['cuenta_id' => 74, 'debito' => 34204333.00, 'credito' => 0, 'desc' => 'SALDO SEGÚN LIBROS', 'linea' => 2],
        ['cuenta_id' => 1437, 'debito' => 257445.00, 'credito' => 0, 'desc' => 'PÉRDIDA DEL PERIODO', 'linea' => 3]
    ];
    ...
    $db->commit();
    echo "Base de datos restaurada correctamente con IDs verificados.\n";
