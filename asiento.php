...
<body class="h-full font-sans flex">
    ...
    <aside
        class="w-16 bg-slate-950 flex-shrink-0 flex flex-col items-center py-6 gap-6 z-50 overflow-y-auto no-scrollbar">
        ...
        <a href="comprobantes.php" class="p-3 text-slate-500 hover:text-white transition-colors"
            title="Asientos y Comprobantes">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
            </svg>
        </a>
        <div class="w-10 h-10 rounded-xl bg-blue-600 flex items-center justify-center text-white shadow-lg shadow-blue-500/20 cursor-default"
    ...
    <main class="flex-1 overflow-auto">
        ...
        <header
            class="bg-white border-b border-slate-200 px-5 py-2.5 flex items-center gap-2 sticky top-0 z-20 flex-wrap">
            ...
            <div class="flex gap-4 text-xs text-slate-500 flex-wrap">
                ...
                <span class="<?= $periodoAct ? 'text-green-600' : 'text-red-500' ?>">
                    <b>Período:</b>
                    <?= $periodoAct ? date('M Y', mktime(0, 0, 0, (int) $periodoAct['mes'], 1, (int) $periodoAct['anio'])) : 'CERRADO' ?>
                </span>
            </div>
        </header>
            ...
            <div class="flex flex-wrap gap-3 items-end">
                ...
                <div class="flex-shrink-0 flex gap-3 ml-2">
                    ...
                    <div class="flex items-end pb-0.5">
                        <span id="badge-pd"
                            class="px-2 py-0.5 rounded-full text-xs font-bold text-white badge-descuadre opacity-60">PD
                            ✗</span>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function nuevaLinea() {
            return {
                cuenta_id: null, cuenta_codigo: '', cuenta_nombre: '', tercero_id: null, tercero_nombre: '',
        ...
        async function guardarComprobante() {
            ...
            const payload = {
                ...
                lineas: lineasValidas.map(l => ({
                    ...
                    doc_cruce_tipo: l.doc_cruce_tipo || null,
                    doc_cruce_num: l.doc_cruce_num || null,
                    fecha: l.fecha || null,
                })),
            };
